...
r, gr = load_gr_file('Au_10nm_d204-00002_00009_sum.gr')
r = r[:-1]
gr = gr[:-1]

# Build NP
atomsio = build_sphere_np('1100138.cif', 100. / 2)
...
# Starting PDF
pdf, fq = wrap_pdf(atoms, qmin=qmin, qbin=qbin, rmax=60)
...
plt.show()
'''
calc = PDFCalc(gobs=gr, qmin=qmin, conv=1000, qbin=.1, potential='rw', rmax=60)
